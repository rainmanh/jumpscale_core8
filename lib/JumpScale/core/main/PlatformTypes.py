...
class PlatformTypes:
    ...
    def __init__(self):
        ...
        self._platformParents["cygwin32"] = ["win32"]
        self._platformParents["cygwin64"] = ["win64"]
        self._platformParents["win2008_64"]=["win64"]
        self._platformParents["win2012_64"]=["win64"]
        self._platformParents["cygwin_nt-10.064"] = ["cygwin64"]
        self._platformParents["cygwin_nt-10.032"] = ["cygwin32"]
