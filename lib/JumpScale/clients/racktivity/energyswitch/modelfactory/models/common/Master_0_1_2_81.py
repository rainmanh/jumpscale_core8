...
from JumpScale.clients.racktivity.energyswitch.modelfactory.models.common.Master_0_1_2_21 import Model as Master
...
class Model(Master):
    def __init__(self, parent):
        ...
        self._guidTable.update({
            # added only those that are needed for snmp configuration, others omitted
            10212: Value(u"type='TYPE_UNSIGNED_NUMBER'\nsize=1\nlength=1\nunit=''\nscale=0"),  # SNMPTrapUser
            10222: Value(u"type='TYPE_ENUM'\nsize=1\nlength=1\nunit=''\nscale=0")  # SNMPTrapEnable
        })
