    ...
    def path(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property path input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: disk, value was:" + str(value)
                raise TypeError(msg)
    ...
    def fs(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property fs input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: disk, value was:" + str(value)
                raise TypeError(msg)
    ...
    def mounted(self, value):
        if not isinstance(value, bool) and value is not None:
            if isinstance(value, str) and j.basetype.boolean.checkString(value):
                ...
                msg="property mounted input error, needs to be bool, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: disk, value was:" + str(value)
                raise TypeError(msg)
    ...
    def mountpoint(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property mountpoint input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: disk, value was:" + str(value)
                raise TypeError(msg)
    ...
    def active(self, value):
        if not isinstance(value, bool) and value is not None:
            if isinstance(value, str) and j.basetype.boolean.checkString(value):
                ...
                msg="property active input error, needs to be bool, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: disk, value was:" + str(value)
                raise TypeError(msg)
    ...
    def model(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property model input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: disk, value was:" + str(value)
                raise TypeError(msg)
    ...
    def description(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property description input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: disk, value was:" + str(value)
                raise TypeError(msg)
    ...
    def lastcheck(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property lastcheck input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: disk, value was:" + str(value)
                raise TypeError(msg)
    ...
    def guid(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property guid input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: disk, value was:" + str(value)
                raise TypeError(msg)
