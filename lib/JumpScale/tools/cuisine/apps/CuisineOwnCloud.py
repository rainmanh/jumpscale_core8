...
class CuisineOwnCloud(app):
    ...
    def install(self, start=True, storagepath="/var/www/html", sitename="owncloud.com"):
        """
        ...
        self._cuisine.core.execute_bash(C)
        self._cuisine.core.file_write("$appDir/nginx/etc/sites-available/", content=owncloudsiterules)
