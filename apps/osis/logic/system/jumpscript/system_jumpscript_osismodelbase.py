    ...
    def name(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property name input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: jumpscript, value was:" + str(value)
                raise TypeError(msg)
    ...
    def descr(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property descr input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: jumpscript, value was:" + str(value)
                raise TypeError(msg)
    ...
    def category(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property category input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: jumpscript, value was:" + str(value)
                raise TypeError(msg)
    ...
    def organization(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property organization input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: jumpscript, value was:" + str(value)
                raise TypeError(msg)
    ...
    def author(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property author input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: jumpscript, value was:" + str(value)
                raise TypeError(msg)
    ...
    def license(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property license input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: jumpscript, value was:" + str(value)
                raise TypeError(msg)
    ...
    def version(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property version input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: jumpscript, value was:" + str(value)
                raise TypeError(msg)
    ...
    def action(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property action input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: jumpscript, value was:" + str(value)
                raise TypeError(msg)
    ...
    def source(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property source input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: jumpscript, value was:" + str(value)
                raise TypeError(msg)
    ...
    def path(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property path input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: jumpscript, value was:" + str(value)
                raise TypeError(msg)
    ...
    def queue(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property queue input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: jumpscript, value was:" + str(value)
                raise TypeError(msg)
    ...
    def guid(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property guid input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: jumpscript, value was:" + str(value)
                raise TypeError(msg)
