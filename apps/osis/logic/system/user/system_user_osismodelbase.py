    ...
    def domain(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property domain input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: user, value was:" + str(value)
                raise TypeError(msg)
    ...
    def passwd(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property passwd input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: user, value was:" + str(value)
                raise TypeError(msg)
    ...
    def active(self, value):
        if not isinstance(value, bool) and value is not None:
            if isinstance(value, str) and j.basetype.boolean.checkString(value):
                ...
                msg="property active input error, needs to be bool, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: user, value was:" + str(value)
                raise TypeError(msg)
    ...
    def description(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property description input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: user, value was:" + str(value)
                raise TypeError(msg)
    ...
    def authkey(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property authkey input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: user, value was:" + str(value)
                raise TypeError(msg)
    ...
    def data(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property data input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: user, value was:" + str(value)
                raise TypeError(msg)
    ...
    def guid(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property guid input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: user, value was:" + str(value)
                raise TypeError(msg)
