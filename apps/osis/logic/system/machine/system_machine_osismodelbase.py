    ...
    def name(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property name input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: machine, value was:" + str(value)
                raise TypeError(msg)
    ...
    def netaddr(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property netaddr input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: machine, value was:" + str(value)
                raise TypeError(msg)
    ...
    def active(self, value):
        if not isinstance(value, bool) and value is not None:
            if isinstance(value, str) and j.core.types.bool.checkString(value):
                ...
                msg="property active input error, needs to be bool, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: machine, value was:" + str(value)
                raise TypeError(msg)
    ...
    def state(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property state input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: machine, value was:" + str(value)
                raise TypeError(msg)
    ...
    def description(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property description input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: machine, value was:" + str(value)
                raise TypeError(msg)
    ...
    def otherid(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property otherid input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: machine, value was:" + str(value)
                raise TypeError(msg)
    ...
    def type(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property type input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: machine, value was:" + str(value)
                raise TypeError(msg)
    ...
    def guid(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property guid input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: machine, value was:" + str(value)
                raise TypeError(msg)
