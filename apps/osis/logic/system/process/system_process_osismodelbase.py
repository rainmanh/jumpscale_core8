    ...
    def aysdomain(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property aysdomain input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: process, value was:" + str(value)
                raise TypeError(msg)
    ...
    def aysname(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property aysname input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: process, value was:" + str(value)
                raise TypeError(msg)
    ...
    def pname(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property pname input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: process, value was:" + str(value)
                raise TypeError(msg)
    ...
    def sname(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property sname input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: process, value was:" + str(value)
                raise TypeError(msg)
    ...
    def instance(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property instance input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: process, value was:" + str(value)
                raise TypeError(msg)
    ...
    def active(self, value):
        if not isinstance(value, bool) and value is not None:
            if isinstance(value, str) and j.core.types.bool.checkString(value):
                ...
                msg="property active input error, needs to be bool, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: process, value was:" + str(value)
                raise TypeError(msg)
    ...
    def cmd(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property cmd input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: process, value was:" + str(value)
                raise TypeError(msg)
    ...
    def workingdir(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property workingdir input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: process, value was:" + str(value)
                raise TypeError(msg)
    ...
    def parent(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property parent input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: process, value was:" + str(value)
                raise TypeError(msg)
    ...
    def type(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property type input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: process, value was:" + str(value)
                raise TypeError(msg)
    ...
    def statkey(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property statkey input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: process, value was:" + str(value)
                raise TypeError(msg)
    ...
    def guid(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property guid input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: process, value was:" + str(value)
                raise TypeError(msg)
