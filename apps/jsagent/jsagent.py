...
class ProcessManager():
    def __init__(self, opts):
        ...
        hrd = j.data.hrd.get(j.sal.fs.joinPaths(j.dirs.cfgDir, 'jsagent', 'grid.hrd'), prefixWithName=False)
        hrd.set('grid.id', opts.gid)
        hrd.set('grid.node.roles', [])
