...
class CuisineAlba(base):
    ...
    def _install_deps_opam(self):
        ...
        janestreet = self._cuisine.development.git.pullRepo(
    ...
    def _install_deps_sources(self):
        self._cuisine.core.file_write('/etc/apt/sources.list.d/wily-universe.list',
    ...
    def _install_deps_ordma(self):
        ...
        #
        commit = 'tags/0.0.2'
        ordmadest = self._cuisine.development.git.pullRepo(
    ...
    def _install_deps_gobjfs(self):
        ...
        gobjfsdest = self._cuisine.development.git.pullRepo(
