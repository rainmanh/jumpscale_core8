...
class Jumpscript(OsisBaseObject):
    ...
    def getUniqueKey(self):
        ...
        """
        return j.tools.hash.md5_string(str([self.organization,self.category,self.version,self.name,self.gid,self.source, self.roles, self.queue]))  # need to make sure roles & source cannot be changed
