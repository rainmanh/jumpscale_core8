...
# QUESTION: *2
# THATS UGLY don't do that, this loads a lot of code each time you load, thisis not the right way to do it
# try:
#     from jscompl import j  # js stub generated by j.tools.JS8Stub
# except:
#     pass
