...
def getContentKey(obj):
    dd = j.code.object2json(obj, True, ignoreKeys=["guid", "id", "sguid",
                                                   "moddate", 'lastcheck'], ignoreUnderscoreKeys=True)
        ...
        for domain in domains:
            ...
            for disk in xml.findall('devices/disk'):
                ...
                if old:
                    ...
                    for key in ['path', 'type', 'devicename', 'machineid',
                                'active', 'size', 'sizeondisk', 'backingpath']:
