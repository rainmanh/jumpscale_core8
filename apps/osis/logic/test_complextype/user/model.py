...
from test_complextype_user_osismodelbase import test_complextype_user_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class test_complextype_user(OsisBaseObject,test_complextype_user_osismodelbase):
