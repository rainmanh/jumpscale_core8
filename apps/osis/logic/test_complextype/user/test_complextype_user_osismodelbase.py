    ...
    def organization(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property organization input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/test_complextype/model.spec, name model: user, value was:" + str(value)
                raise TypeError(msg)
    ...
    def name(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property name input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/test_complextype/model.spec, name model: user, value was:" + str(value)
                raise TypeError(msg)
    ...
    def guid(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property guid input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/test_complextype/model.spec, name model: user, value was:" + str(value)
                raise TypeError(msg)
