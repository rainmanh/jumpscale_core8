    ...
    def description(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property description input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: alert, value was:" + str(value)
                raise TypeError(msg)
    ...
    def descriptionpub(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property descriptionpub input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: alert, value was:" + str(value)
                raise TypeError(msg)
    ...
    def category(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property category input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: alert, value was:" + str(value)
                raise TypeError(msg)
    ...
    def tags(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property tags input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: alert, value was:" + str(value)
                raise TypeError(msg)
    ...
    def state(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property state input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: alert, value was:" + str(value)
                raise TypeError(msg)
    ...
    def guid(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property guid input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: alert, value was:" + str(value)
                raise TypeError(msg)
