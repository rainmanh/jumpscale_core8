...
# do.installJS(base="/opt/jumpscale8",clean=True,insystem=False,pythonversion=3,web=True)
...
get("https://github.com/Jumpscale/jumpscale_core8")
...
get("https://github.com/Jumpscale/ays_jumpscale8")
