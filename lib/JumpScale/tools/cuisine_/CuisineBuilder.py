...
class CuisineBuilder(object):
    ...
    def _startCore(self, nid, gid):
        ...
        cfg["main"]["message_ID_file"] = self.cuisine.joinpaths(cfgdir,"/core/.mid")
        cfg["main"]["include"] = self.cuisine.joinpaths(cfgdir,"/core/conf")
        cfg["extensions"]["sync"]["cwd"] = self.cuisine.joinpaths(cfgdir,"/core/extensions")
        cfg["extensions"]["jumpscript"]["cwd"] = self.cuisine.joinpaths(cfgdir,"/core/extensions/jumpscript")
        cfg["extensions"]["jumpscript_content"]["cwd"] = self.cuisine.joinpaths(cfgdir,"/core/extensions/jumpscript")
        cfg["extensions"]["js_daemon"]["cwd"] = self.cuisine.joinpaths(cfgdir,"/core/extensions/jumpscript")
        cfg["extensions"]["js_daemon"]["env"]["JUMPSCRIPTS_HOME"] = self.cuisine.joinpaths(cfgdir,"/core/jumpscripts/")
        cfg["logging"]["db"]["address"] = self.cuisine.joinpaths(cfgdir,"/core/logs")
