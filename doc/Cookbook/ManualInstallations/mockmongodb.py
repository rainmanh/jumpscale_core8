...
class MockMONGO(object):
    def mock(self):
         ...
         j.sal.process.execute('rm -f /optvar/var/mongodb/main/mongod.lock;export LC_ALL=C;/opt/mongodb/bin/mongod --dbpath  /optvar/var/mongodb/ --smallfiles --rest --httpinterface' , die=True, outputToStdout=True) 
