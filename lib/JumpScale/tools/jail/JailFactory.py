...
class JailFactory(object):
    ...
    def prepareJSJail(self):
        ...
        # j.system.process.execute("chmod -R 777 /opt/jumpscale8/bin")
        # j.system.process.execute("chmod -R 777 /opt/jumpscale8/lib")
        # j.system.process.execute("chmod -R 777 /opt/jumpscale8/libext")
