...
class ActionDecorator(object):
    ...
    def __init__(self,action=False,force=False, deps=[]):
        self.action=action
        self.force=force
        self.deps = deps
    def __call__(self, func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if action:
                ...
                action0=j.actions.add(action=func, deps=dependencies, actionRecover=None,args=args,kwargs=kwargs,die=True,stdOutput=True,errorOutput=True,retry=0,executeNow=True,selfGeneratorCode=cm,force=force)
