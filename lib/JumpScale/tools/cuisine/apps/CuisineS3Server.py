...
class CuisineS3Server(app):
    ...
    def install(self, start=False, storageLocation="/data/", metaLocation="/meta/"):
        ...
        self.cuisine.core.dir_remove('$JSAPPDIR/S3', recursive=True)
        self.cuisine.core.run('mv {} $JSAPPDIR/'.format(path))
        ...
        content = self.cuisine.core.file_read('$JSAPPDIR/S3/package.json')
        ...
        self.cuisine.core.file_write('$JSAPPDIR/S3/package.json', content)
