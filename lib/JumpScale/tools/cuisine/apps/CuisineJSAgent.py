...
class CuisineJSAgent(app):
    ...
    def install(self, start=False, gid=1, ctrl_addr='', ctrl_port=4444, ctrl_passwd='', reset=False):
        ...
        self._cuisine.core.file_link('$CODEDIR/github/jumpscale/jumpscale_core8/apps/jsagent', '$JSAPPDIR/jsagent')
        if start is True:
    ...
    def start(self, gid, ctrl_addr, ctrl_port=4444, ctrl_passwd=''):
        ...
        self._cuisine.processmanager.ensure(name="jsagent", cmd=cmd, path='$JSAPPDIR/jsagent')
