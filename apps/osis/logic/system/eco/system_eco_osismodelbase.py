    ...
    def appname(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property appname input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: eco, value was:" + str(value)
                raise TypeError(msg)
    ...
    def type(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property type input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: eco, value was:" + str(value)
                raise TypeError(msg)
    ...
    def state(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property state input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: eco, value was:" + str(value)
                raise TypeError(msg)
    ...
    def errormessage(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property errormessage input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: eco, value was:" + str(value)
                raise TypeError(msg)
    ...
    def errormessagePub(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property errormessagePub input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: eco, value was:" + str(value)
                raise TypeError(msg)
    ...
    def category(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property category input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: eco, value was:" + str(value)
                raise TypeError(msg)
    ...
    def tags(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property tags input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: eco, value was:" + str(value)
                raise TypeError(msg)
    ...
    def code(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property code input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: eco, value was:" + str(value)
                raise TypeError(msg)
    ...
    def funcname(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property funcname input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: eco, value was:" + str(value)
                raise TypeError(msg)
    ...
    def funcfilename(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property funcfilename input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: eco, value was:" + str(value)
                raise TypeError(msg)
    ...
    def backtrace(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property backtrace input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: eco, value was:" + str(value)
                raise TypeError(msg)
    ...
    def backtraceDetailed(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property backtraceDetailed input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: eco, value was:" + str(value)
                raise TypeError(msg)
    ...
    def extra(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property extra input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: eco, value was:" + str(value)
                raise TypeError(msg)
    ...
    def guid(self, value):
        if not isinstance(value, str) and value is not None:
            if isinstance(value, str) and j.core.types.string.checkString(value):
                ...
                msg="property guid input error, needs to be str, specfile: /opt/jumpscale8/apps/osis/logic/system/model.spec, name model: eco, value was:" + str(value)
                raise TypeError(msg)
