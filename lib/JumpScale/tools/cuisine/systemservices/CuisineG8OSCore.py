...
class CuisineG8OSCore(app):
    ...
    def build(self, start=True, gid=None, nid=None, install=True):
        ...
        self._cuisine.core.dir_ensure("$TEMPLATEDIR/cfg/agent", recursive=True)
        self._cuisine.core.file_ensure("$TEMPLATEDIR/cfg/agent/.mid")
    ...
    def install(self, start=True, gid=None, nid=None):
        ...
        self._cuisine.core.file_copy("%s/extensions" % sourcepath, "$TEMPLATEDIR/cfg/agent", recursive=True)
        self._cuisine.core.file_copy("%s/g8os.toml" % sourcepath, "$TEMPLATEDIR/cfg/agent")
        self._cuisine.core.dir_ensure("$TEMPLATEDIR/cfg/agent/conf/")
    ...
    def start(self, gid, nid, controller_url="http://127.0.0.1:8966"):
        ...
        self._cuisine.core.dir_ensure('$JSCFGDIR/agent/')
        self._cuisine.core.file_copy('$TEMPLATEDIR/cfg/agent', '$JSCFGDIR/', recursive=True)
        ...
        self._cuisine.core.file_write("$JSCFGDIR/agent/g8os.toml", C, replaceArgs=True)
